...
const STEPS = [
  ...
  },
  {
    n: "04",
    tag: "놓치지 않기",
    title: "마감 3시간 전, 알림이 붙잡아 줘요",
    img: "/guide/alarm.png",
    desc: "미루면 사라지는 결심을 마감 3시간·1시간·30분 전 알림이 붙잡아 줍니다. 인증을 마치면 그날 알림은 자동으로 꺼져요.",
    points: ["마감 임박 알림 3단계 (켜고 끄기 자유)", "아침 리마인더 시각 설정", "네이티브 앱이라 닫혀 있어도 정확히 울림"],
  },
  {
    n: "05",
    tag: "기록·추억",
