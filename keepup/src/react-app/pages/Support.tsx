...
const FAQ: { q: string; a: string }[] = [
  {
    q: "앱 데이터가 서버에 저장되나요?",
    a: "아니요. Log Challenge 앱의 루틴·인증 사진·메모는 모두 내 폰 안에만 저장됩니다. 회원가입도 없습니다. 웹 성과 게시판에 직접 올리는 글만 서버에 저장됩니다.",
  },
  {
    q: "알림이 안 울려요.",
    a: "설정에서 Log Challenge의 알림 권한과 '정확한 알람' 권한을 허용해 주세요. 안드로이드는 배터리 최적화 대상에서 Log Challenge를 제외하면 알림이 정확해집니다.",
  },
  {
    q: "인증 사진의 날짜 워터마크는 지울 수 있나요?",
    a: "아니요. 날짜·시각 워터마크는 인증의 신뢰를 위한 Log Challenge의 핵심 규칙이라 끌 수 없습니다.",
  },
  {
